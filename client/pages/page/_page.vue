<template>
  <div>
    <head-info />
    <el-row class="article_wrap animated bounce" type="flex" justify="center">
      <el-col v-for="article in articles" :xs="22" :sm="20" :lg="18" :xl="14" :key="article.id" class="article">
    ...
    <el-pagination :total="total" :page-size="PAGESIZE" class="page animated bounce" background :current-page="curPage"
